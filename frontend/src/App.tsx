      ...
      <div className="hero bg-base-200 min-h-screen">
        ...
        <div className="hero-content flex-col lg:flex-row">
          <div className="tabs tabs-lift">
            <input type="radio" name="my_tabs_3" className="tab" aria-label="Create Token" defaultChecked/>
            ...
            <input type="radio" name="my_tabs_3" className="tab" aria-label="Add Liquidity" />
            <div className="tab-content bg-base-100 border-base-300 p-6">
              <LiquidityForm />
            </div>

            <input type="radio" name="my_tabs_3" className="tab" aria-label="Swap" />
            <div className="tab-content bg-base-100 border-base-300 p-6">
            <SwapForm />
            </div>
          </div>
